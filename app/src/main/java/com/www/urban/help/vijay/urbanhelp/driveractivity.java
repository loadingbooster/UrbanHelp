        ...
        calenderView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
              ...
              //  Calendar nextcal = Calendar.getInstance();
                lastcal.set(Calendar.MONTH,month);
                lastcal.set(Calendar.DAY_OF_MONTH,dayOfMonth);
                lastcal.set(Calendar.YEAR,year);
                lastcal.add(Calendar.DATE,amount);
                String toDate=dateFormat.format(lastcal.getTime());
          //      if(currentdate.compareTo(toDate) == 0){
            //        Toast.makeText(driveractivity.this, "Same Day", Toast.LENGTH_SHORT).show();
              //  }
